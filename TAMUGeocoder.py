...
if(arcpy.GetParameter(7)):
    fields_to_add = ["Latitude","Longitude","MatchType","Result","Block","Group","Tract","Cnty_Fips","CBSA_Fips","CBSA_Micro","MCD_Fips","MetDiv","MSA_Fips","Place_Fips","State_Fips","Group"]
else:
...
if(arcpy.GetParameter(7)):
    fields_to_pass = [address,city,state,zip,'Latitude','Longitude','MatchType','Result',"Block","Group","Tract","Cnty_Fips","CBSA_Fips","CBSA_Micro","MCD_Fips","MetDiv","MSA_Fips","Place_Fips","State_Fips","Group"]

else:
    fields_to_pass = [address,city,state,zip,'Latitude','Longitude','MatchType','Result']
...
with arcpy.da.UpdateCursor(tablePath, fields_to_pass) as cursor:
    ...
    for row in cursor:
            ...
            if(arcpy.GetParameter(7) and responseList[9] == "Success"):
                row[8] = responseList[40]
                row[9] = responseList[41]
                row[10] = responseList[42]
                row[11] = responseList[43]
                row[12] = responseList[44]
                row[13] = responseList[45]
                row[14] = responseList[46]
                row[15] = responseList[47]
                row[16] = responseList[48]
                row[17] = responseList[49]
                row[18] = responseList[50]
